...
Secrets for `canonical-cloud/canonical-mcp-server.rs` are **committed, encrypted**, with [sops] + [age],
...
```sh
just env-docker-run dev ghcr.io/canonical-cloud/canonical-mcp-server.rs:dev
